            ...
            pub: function (targetElement, opts) {
                        ...
                        for (var c = 0; c < pickerDims.palette.cols && si < THIS._palette.length; c++, si++) {
                            ...
                            sw.style.left =
                                (pickerDims.palette.cols <= 1
                                    ? 0
                                    : Math.round(10 * (c * ((pickerDims.contentW - pickerDims.palette.cellW) / (pickerDims.palette.cols - 1)))) /
                                      10) + 'px';
                ...
                if (!this.targetElement) {
                    if (typeof targetElement === 'string' && /^[a-zA-Z][\w:.-]*$/.test(targetElement)) {
                        ...
                        throw new Error(
                            "If '" + possiblyId + "' is supposed to be an ID, please use '#" + possiblyId + "' or any valid CSS selector."
                        );
                    }
